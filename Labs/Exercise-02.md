...
1. On the **Define an endpoint to deploy your model** page, under the **Model deployments** tab, select **+ Deploy base model (2)**.
...
1. On **Create a new flow** blade, under **Standard flow**, click on **Create (1)**, then enter **Promptflow-<inject key="DeploymentID" enableCopy="false"/> (2)** under **Folder name**, and click on **Create (3).** 
...
1. The prompt flow authoring page opens. You can start authoring your flow now. By default, you will be able to see a sample flow. This example flow has nodes for the LLM and Python tools.
...
1. You can view the **flow run status** and **output** in the **Outputs** section under the **Output** tab.

    ![](./media/image-31.png)

1. From the top menu, select **+ Prompt** to add the prompt tool to your flow, enter the name of the flow as **modelflow**, and select **Add**.
